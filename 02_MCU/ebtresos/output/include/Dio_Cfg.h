...
/**
* @brief          Symbolic name for the port LED_OUT.
*
*/
#define DioConf_DioPort_LED_OUT  ((uint8)0x03U)

/**
* @brief          Symbolic name for the channel LED_R.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_LED_R ((uint16)0x006fU)
...
/**
* @brief          Symbolic name for the channel LED_B.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_LED_B ((uint16)0x0060U)

/* ---------- SW_IN ---------- */

/**
* @brief          Symbolic name for the port SW_IN.
*
*/
#define DioConf_DioPort_SW_IN  ((uint8)0x02U)
...
/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_SW_2 ((uint16)0x004cU)

/**
* @brief          Symbolic name for the channel SW_3.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_SW_3 ((uint16)0x004dU)
